...
<p>
    ...
    <p>
        <asp:GridView ID="GridUsuario" runat="server" AutoGenerateColumns="False" Width="200px" AutoGenerateDeleteButton="True" AutoGenerateEditButton="True" OnRowDeleting="GridUsuario_RowDeleting" OnRowEditing="GridUsuario_RowEditing">
            <Columns>
