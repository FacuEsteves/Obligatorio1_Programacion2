...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <p>
        &nbsp;</p>
    <p>
        <asp:GridView ID="GridBarcoRapido" runat="server" AutoGenerateDeleteButton="True" OnRowDeleting="GridBarcoRapido_RowDeleting">
        </asp:GridView>
    </p>
    <p>
        <asp:GridView ID="GridBarcoLento" runat="server" AutoGenerateDeleteButton="True" OnRowDeleting="GridBarcoLento_RowDeleting">
        </asp:GridView>
    </p>
</asp:Content>
